...
<html>
  <body>
    <div>
        VERSION VENDEUR
      <a href="https://mecageek.000webhostapp.com/donneeEspaceMembre/validation_vendeur.php?mail='.urlencode($mail).'&key='.$key.'">Cliquez ici pour confirmer !</a>
    </div>
  </body>
</html>';

$mail_envoie->AltBody = 'Ca marche!';
