<?php
        ...
        if(isset($_POST['forminscription'])){
          ...
          $codeVendeur = $_POST['code_vendeur'];
        	if (!empty($_POST['nom']) AND !empty($_POST['mail']) AND !empty($_POST['mdp'])) {
        		...
        		if ($nomlength <= 255) {
                    ...
                    if($codeVendeur == "0123"){
                      ...
                      $update_user = $bdd -> prepare("UPDATE membre SET vendeur = 1 WHERE email = ? AND confirmkey = ?");
	...
	<div align="center" class="jumbotron">
        ...
        <tr>
          <td>
					...
					<td>
						<input type="text" id="code_vendeur" name="code_vendeur" required>
					</td>
        </tr>
			</table>
